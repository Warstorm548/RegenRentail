...
public class MemberCommand implements CommandExecutor, TabCompleter {
    ...
    public MemberCommand(RegionRental plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // Permission check
        if (!player.hasPermission("regionrental.member")) {
        ...
        // Usage check
        if (args.length < 3) {
            player.sendMessage(ChatColor.RED + "Usage: /rrmember <add|remove> <region> <username>");
            player.sendMessage(ChatColor.YELLOW + "Example: /rrmember add shop1 PlayerName");
            player.sendMessage(ChatColor.YELLOW + "Example: /rrmember remove world:shop1 PlayerName");
            return true;
        }
