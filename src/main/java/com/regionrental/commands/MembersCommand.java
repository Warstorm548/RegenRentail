...
public class MembersCommand implements CommandExecutor, TabCompleter {
    ...
    public MembersCommand(RegionRental plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // Permission check
        if (!player.hasPermission("regionrental.members")) {
        ...
        // Usage check
        if (args.length < 1) {
            player.sendMessage(ChatColor.RED + "Usage: /rrmembers <region>");
            player.sendMessage(ChatColor.YELLOW + "Example: /rrmembers shop1");
            player.sendMessage(ChatColor.YELLOW + "Example: /rrmembers world:shop1");
            return true;
        }
