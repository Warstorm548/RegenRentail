...
class ConfigManager(private val plugin: RegionRental) {
    ...
    private fun loadConfig() {
        // General settings
        prefix = config.getString("general.prefix", "&8[&6RegionRental&8]&r ")?.color() ?: ""
    ...
    private fun loadMessages() {
        messages = mutableMapOf(
            ...
            "region-removed" to "&aRegionRental setup completely removed from &e{region}&a:",
