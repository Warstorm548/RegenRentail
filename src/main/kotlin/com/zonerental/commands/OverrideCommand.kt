...
sealed class OverrideSetting<T> {
    ...
    abstract fun applyToRegion(plugin: ZoneRental, regionName: String, world: World, value: T)
    abstract fun applyToGroup(plugin: ZoneRental, groupName: String, value: T)
    abstract fun formatSuccess(value: T, plugin: ZoneRental): String
    ...
    data object Price : OverrideSetting<Double>() {
        ...
        override val usage = "/zroverride price <group:group_name|world:region> <amount>"
        override val examples = listOf(
            "/zroverride price group:shop_group 500",
        ...
        override fun applyToRegion(plugin: ZoneRental, regionName: String, world: World, value: Double) {
            plugin.regionsConfig.setRegionPrice(regionName, world, value)
        }

        override fun applyToGroup(plugin: ZoneRental, groupName: String, value: Double) {
    ...
    data object Duration : OverrideSetting<Int>() {
        ...
        override val usage = "/zroverride duration <group:group_name|world:region> <days>"
        ...
        override fun applyToRegion(plugin: ZoneRental, regionName: String, world: World, value: Int) {
            plugin.regionsConfig.setRegionDuration(regionName, world, value)
        }

        override fun applyToGroup(plugin: ZoneRental, groupName: String, value: Int) {
    ...
    data object MaxExtensions : OverrideSetting<Int>() {
        ...
        override val usage = "/zroverride maxextensions <group:group_name|world:region> <count>"
        override val examples = emptyList<String>()
    ...
    data object ExtensionPrice : OverrideSetting<Double>() {
        ...
        override val usage = "/zroverride extensionprice <group:group_name|world:region> <amount>"
    ...
    data object AllowExtensions : OverrideSetting<Boolean>() {
        ...
        override val usage = "/zroverride allowextensions <group:group_name|world:region> <true|false>"
        override val examples = emptyList<String>()
        ...
        override fun applyToRegion(plugin: ZoneRental, regionName: String, world: World, value: Boolean) {
            plugin.regionsConfig.setRegionAllowExtensions(regionName, world, value)
        }

        override fun applyToGroup(plugin: ZoneRental, groupName: String, value: Boolean) {
    ...
    data object ExtensionDuration : OverrideSetting<Int>() {
        ...
        override val usage = "/zroverride extensionduration <group:group_name|world:region> <days>"
        override val examples = emptyList<String>()
 ...
 */
class OverrideCommand(private val plugin: ZoneRental) : CommandExecutor, TabCompleter {
